...
let employeCounter = 4; // Compteur pour générer les matricules (commence à 4 car EMP0001-EMP0003 existent déjà)
...
function initEventListeners() {
    ...
    // Écouteur pour le champ contact - mettre à jour le mot de passe par défaut
...
function openAddModal(type) {
    ...
    // Pour les employés, générer un nouveau matricule et définir le mot de passe par défaut
    if (type === 'employe') {
        ...
        document.getElementById('employe-password').value = ''; // Vider le mot de passe
    }
...
function openEditModal(type, id) {
    ...
    if (type === 'employe') {
        ...
        document.getElementById('employe-password').value = '+241 01 23 45 67'; // Mot de passe par défaut
