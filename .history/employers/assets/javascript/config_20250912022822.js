...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('edit-profile-btn').addEventListener('click', function() {
        isEditing = true;
        toggleEditMode();
        showNotificationToken('Mode édition activé', 'fas fa-edit', 'info');
    });
    ...
    document.getElementById('cancel-edit-btn').addEventListener('click', function() {
        ...
        toggleEditMode();
        resetForm();
        showNotificationToken('Modifications annulées', 'fas fa-times', 'warning');
    });
    ...
    document.getElementById('change-photo-btn').addEventListener('click', openPhotoModal);
    document.getElementById('photo-overlay').addEventListener('click', openPhotoModal);
    document.getElementById('avatar-display').addEventListener('click', openPhotoModal);
    ...
    function handlePhotoSelection(file) {
        ...
        if (!allowedTypes.includes(file.type)) {
            notyf.error('Format de fichier non supporté');
            return;
        }

        // Vérifier la taille (5MB max)
        if (file.size > 5 * 1024 * 1024) {
            notyf.error('Fichier trop volumineux (max 5MB)');
            return;
        }
        ...
        reader.onload = function(e) {
            ...
            document.getElementById('photo-size').textContent = formatFileSize(file.size);
    ...
    // Remove photo
    document.getElementById('remove-photo').addEventListener('click', resetPhotoModal);
    ...
    confirmPhotoBtn.addEventListener('click', function() {
        if (selectedPhoto) {
            ...
            closePhotoModal();
            showNotificationToken('Photo mise à jour', 'fas fa-camera', 'success');
    ...
    function resetForm() {
        document.getElementById('lastname').value = 'Martin';
        document.getElementById('firstname').value = 'Jean';
        document.getElementById('email').value = 'jean.martin@graxel.com';
