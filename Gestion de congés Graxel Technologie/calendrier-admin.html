    ...
    <div class="flex h-full">
     ...
     <!-- Navigation -->
                <nav class="space-y-3 flex-1">
                      <a href="dashboard-admin.html" class="nav-item flex items-center space-x-4 px-4 py-4 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-xl hover-lift transition-all duration-300 click-scale">
                            <i class="fas fa-chart-pie w-5 h-5 text-lg"></i>
                        <span>Tableau de bord</span>
                    </a>
                    <a  href="administration.html" class="nav-item flex items-center space-x-4 px-4 py-4 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-xl hover-lift transition-all duration-300 click-scale">
                            ...
                            <div class="p-6 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-blue-500/5 to-purple-500/5">
                                ...
                                <div class="flex space-x-2 overflow-x-auto pb-4">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <select id="departmentFilter" class="department-filter bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-6 py-3 font-medium rounded-xl transition-all duration-300 hover-lift border-0 outline-none cursor-pointer">
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center justify-between">
                                        <span class="text-gray-400 text-sm">Département:</span>
                                        <span id="leaveDetailsDepartment" class="text-white font-semibold">IT</span>
                                    </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-md w-full p-6">
                            <div class="flex flex-col items-center text-center space-y-4">
                                ...
                                <div class="flex items-center space-x-3 w-full">
                                    <button class="flex-1 px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors" onclick="closeModal('confirmModal')">
                                        Annuler
                                    </button>
                                    <button id="confirmActionBtn" class="flex-1 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors" onclick="executeAction()">
                            ...
                            <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p id="detailsDepartmentInfo" class="text-xs text-gray-400 dark:text-gray-500">Département: IT</p>
                                    </div>
                                </div>
...
<div id="toast" class="fixed top-4 right-4 bg-white dark:bg-gray-800 border-l-4 border-green-500 rounded-lg shadow-lg p-4 transform translate-x-full transition-transform duration-300 z-50 min-w-80">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            <div class="flex items-center space-x-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Gestion des congés pour les super admins</p>
                                </div>
                            </div>
                            <p class="text-gray-600 dark:text-gray-400 text-sm mb-4">
                                Solution dédiée aux super admins pour une gestion globale des congés de tous les départements.
                            </p>
                        </div>
                        <div>
                            ...
                            <ul class="space-y-2 text-sm">
                                ...
                                <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Demandes tous départements</a></li>
                                <li><a href="calendrier-manager.html" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Calendrier global</a></li>
   ...
   <script src="assets/javascript/config.js"></script> 
<script src="assets/javascript/calendrier-admin.js"></script>
